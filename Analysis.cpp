...
bool Analysis::Initialize(const MA5::Configuration& cfg, const std::map<std::string,std::string>& parameters)
{
  ...
  Manager()->AddHisto("Efficiencies_e", 2, 0.0, 3.0);
  plot_Efficiencies_e = new TH1F("Efficiencies_e", "Efficiencies_e", 2, 0.0, 3.0);
  ...
  Manager()->AddHisto("Efficiencies_mu", 2, 0.0, 3.0);
  plot_Efficiencies_mu = new TH1F("Efficiencies_mu", "Efficiencies_mu", 2, 0.0, 3.0);
